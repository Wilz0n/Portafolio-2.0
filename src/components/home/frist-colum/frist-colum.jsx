...
<article className='group text-[#E2E2E2] min-h-[200px] blur-effect border-2 border-[#3D2D42] relative rounded-[24px] h-full  circle col-span-5'>
  <div className="px-8 py-4 flex gap-x-4 items-center justify-center h-full">
    <img src="/img/Pixilart-avatar-profile.png" alt="profile-photo" className='rounded-full aspect-square w-[150px]' />
    <div>
      <div className='flex flex-row items-center gap-x-2'>
        <h2 className='text-4xl font-bold'>Hello!</h2>
      </div>
      <p className='text-[20px]'>Front-end developer looking to improve day by day.</p>
    </div>
  </div>
</article>
    <article className="group text-[#E2E2E2] min-h-[200px] blur-effect border-2 border-[#3D2D42] relative rounded-[24px] h-full  circle row col-span-3">
