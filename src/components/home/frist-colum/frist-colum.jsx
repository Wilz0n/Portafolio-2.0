  ...
  return (
    <><article className='group text-[#E2E2E2] min-h-[200px] blur-effect border-2 border-[#3D2D42] relative rounded-[24px] h-full  circle col-span-5'>
      <div className="px-8 py-4 flex gap-x-4 items-center justify-center h-full">
        ...
        <div>
          <h1 className='font-bold text-[36px]'>heyyy!!</h1>
          <p className='text-[36px]'> test de text</p>
        </div>
      </div>
    </article>
    <article class="group text-[#E2E2E2] min-h-[200px] blur-effect border-2 border-[#3D2D42] relative rounded-[24px] h-full  circle row col-span-3">
